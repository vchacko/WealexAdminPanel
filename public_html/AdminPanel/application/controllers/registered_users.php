...
class Registered_users extends Widgetcontroller {
    public function __construct()
    {
        $this->sg = 'User'; /* Singular */
        $this->pl = 'Users';  /* Plural */
        /*
...
//        $this->field_names = array(
                parent::__construct(array(
                                    ...
                                    'gender'     => array(
                                                            'title' => 'Gender',
                                                            'ft'    => array('radio',array( 'U'=>'Not Specified','M'=>'Male','F'=>'Female'),'M'),
                                                            'ss'    => array('select',array('U'=>'Not Specified','M'=>'Male','F'=>'Female'))
                                                            ),
                                    'address'    => array(
                                                            'title' => 'Address',
                                                            'ss'    => 15,
        ...
        $this->Generic_model->initialise('registered_users');  /*Database Name*/
